...
import torch
from ...core import *
from ...executor import BaseGraphExecutor, TorchExecutor
from ...IR import BaseGraph, BaseGraph, Operation, QuantableOperation
from ...IR.quantize import QuantableGraph
from ..algorithm.training import *
from ..measure import torch_mean_square_error, torch_snr_error
from ..qfunction.linear import PPQLinearQuantFunction
...
class RoundTuningPass(TrainingBasedPass):
    ...
    def finetune(
        ...
        # record pre training loss.
        pre_loss = self.compute_block_loss(block=block, qt_inputs=qt_inputs, fp_outputs=fp_outputs, executor=executor)
