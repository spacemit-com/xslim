...
import torch
from ...core import empty_ppq_cache
from ...executor import BaseGraphExecutor
from ...executor.torch import TorchExecutor
from ...IR import BaseGraph, Operation, QuantableOperation, SearchableGraph, TraversalCommand
from ...IR.base.graph import BaseGraph
from ..algorithm.equalization import EqualizationPair
...
class ActivationEqualizationPass(QuantizationOptimizationPass):
    def __init__(
        self, interested_layers: List[str] = None, threshold: float = 4.0, optimize_level: int = 1, iterations: int = 10
    ) -> None:
